    ...
    <div className="project-page">
      <div className="project-container">
        ...
        <div className='project-header'>
          ...
          {/* TITLE HEADER */}
          <div className='project-header-title' style={{width : "40%"}}>
            <h1 className='title-project' style={{fontSize : "6em", color: MAIN_COLOR}}>Mister PowerPoint</h1>
            <h3 className='subtitle-project'>Or how to invest 500 hours to get the perfect chrome homepage</h3>
